            ...
            <div class="container">
                ...
                <form>
                    ...
                    <div class="card-details">
                        <div class="form-row">
                            <div class="col-sm-12">
                                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">View Purchase History</button><button class="btn btn-danger btn-block" type="submit">Log Out</button></div>
                            </div>
                        </div>
                    </div>
                </form>
